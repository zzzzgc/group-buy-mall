  ...
  <div class="container">
    ...
    <div style="width: 100%;">
      <i-panel title="物流信息">
        ...
        <i-input :value="detail.logisticsInfo.noutoasiakas.name" title="自提点" disabled></i-input>
        <!--<i-cell :title="'自提点 ' + detail.logisticsInfo.noutoasiakas.name" :label="detail.logisticsInfo.noutoasiakas.address">-->
        <!--</i-cell>-->
    ...
    <div style="width: 100%;display: flex;flex-flow: column nowrap;align-items:center">
      <span style="text-align: right;">合计:{{detail.productTotalPrice}}￥</span>
    </div>
    <!--团购信息-->
    <div style="width: 100%;">
      <i-panel title="团购信息">
    ...
    <!--编辑按钮-->
    <div style="width: 100%;">
      <i-button type="primary" :long="true" @click="handleEditButtonClick">编辑团购</i-button>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      handleEditButtonClick: function () {
        // wx.navigateTo({
        //   // url: '../new/main?orderId=' + orderId + '&createDate=' + createDate
        // })
      }
    },
    // 组件注册
